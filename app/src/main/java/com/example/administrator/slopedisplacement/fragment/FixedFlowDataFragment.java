...
public class FixedFlowDataFragment extends BaseLazyFragment {
    ...
    public static FixedFlowDataFragment newInstance(String schemeID) {
        FixedFlowDataFragment cruiseDataFragment = new FixedFlowDataFragment();
